...
lintpkgs = ./modules ./modules/wallet ./modules/gateway ./modules/host ./modules/renter ./modules/renter/hostdb \
           ./modules/renter/contractor ./node ./node/api/server ./persist ./siatest
lint:
