...
test-long: clean fmt vet lint
	go test --coverprofile=cover.out -v -race -tags='testing debug netgo' -timeout=1200s $(pkgs) -run=$(run)
test-vlong: clean fmt vet lint
	go test --coverprofile=cover.out -v -race -tags='testing debug vlong netgo' -timeout=5000s $(pkgs) -run=$(run)
test-cpu:
