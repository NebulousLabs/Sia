...
type (
	...
	Wallet interface {
		...
		// SendSiacoinsWithAribitraryData sends coins to an address with appended arbitrary data
		SendSiacoinsWithAribitraryData(amount types.Currency, dest types.UnlockHash, arbData []byte) ([]types.Transaction, error)
