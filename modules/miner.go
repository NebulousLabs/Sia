...
type Miner interface {
	// FindBlock will have the miner make 1 attempt to find a solved block. It
	// will give up after a few seconds, returning a block, a bool indiciating
	// whether the block is sovled, and an error.
