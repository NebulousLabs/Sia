...
func newRenter(g modules.Gateway, cs modules.ConsensusSet, tpool modules.TransactionPool, hdb hostDB, hc hostContractor, persistDir string, deps Dependencies) (*Renter, error) {
	if g == nil {
...
func New(g modules.Gateway, cs modules.ConsensusSet, wallet modules.Wallet, tpool modules.TransactionPool, persistDir string) (*Renter, error) {
	...
	return newRenter(g, cs, tpool, hdb, hc, persistDir, &ProductionDependencies{})
}
