...
Hosts accomplish this by submiting storage proofs to the network.
...
We have addiitonally proposed an array of potential changes that range from simple and probably safe to complex and probably unsafe.
