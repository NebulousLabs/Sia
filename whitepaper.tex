...
Intially, 300,000 coins will be minted every block.
...
Years 2, 3, 4, 5, 8, and 20 will have annaul growths of 39\%, 21\%, 11.5\%, 4.4\%, 3.2\%, and 2.3\%, respectively.
...
The clamp on mining grwoth is there to prevent an attacker from being trivially able to dramatically jump or drop the difficulty.
