...
By only needing 10\% out of 100 providers, the client is betting against the most reliable 10\%, instead of betting against the average reliability.
...
If clients behaviorally pay provierds well, then providers are more heavily incentivized to be online all the time.
...
Clients need some metric for picking storage providers.
The arbitrary data leaves room for advanced reputations schemes, however we describe a simple one here.
