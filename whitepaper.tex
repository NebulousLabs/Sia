...
The challenge frequency specifies how often a storage proof must be submitted, and creates discreet \textit{challenge windows} during which a host must submit storage proofs (one proof per window).
...
By adjusting the price of contracts to account for the risks associated with longer duration contracts, hosts can insulate themselves.
