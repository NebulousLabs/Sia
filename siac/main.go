...
func main() {
	...
	walletCmd.AddCommand(walletAddressCmd, walletAddseedCmd, walletInitCmd, walletLoad033xCmd, walletLockCmd, walletSeedsCmd, walletSendCmd, walletStatusCmd, walletUnlockCmd)
