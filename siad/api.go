...
func (d *daemon) initAPI(addr string) {
	...
	handleHTTPRequest(mux, "/gateway/synchronize", d.gatewaySyncHandler)
	handleHTTPRequest(mux, "/gateway/peer/add", d.gatewayAddHandler)
	handleHTTPRequest(mux, "/gateway/peer/remove", d.gatewayRemoveHandler)
