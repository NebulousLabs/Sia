...
// KeyPairSiagOnePointZero matches the KeyPair struct of the siag 1.0 code.
type KeyPairSiagOnePointZero struct {
	Header           string
	Version          string
	Index            int
...
// verifyKeysSiagOnePointZero is a copy-pasted version of the verifyKeys method
// from siag 1.0.
func verifyKeysSiagOnePointZero(uc types.UnlockConditions, folder string, keyname string) error {
	keysRequired := uc.SignaturesRequired
	totalKeys := uint64(len(uc.PublicKeys))
	loadedKeys := make([]KeyPairSiagOnePointZero, totalKeys)
...
// TestVerifyKeysSiagOnePointZero loads some keys generated by siag1.0.
// Verification must still work.
func TestVerifyKeysSiagOnePointZero(t *testing.T) {
	var kp KeyPairSiagOnePointZero
	...
	err = verifyKeysSiagOnePointZero(kp.UnlockConditions, "", "siag_1.0_1of1")
	if err != nil {
		t.Fatal(err)
	}
	...
	err = verifyKeysSiagOnePointZero(kp.UnlockConditions, "", "siag_1.0_1of2")
	if err != nil {
		t.Fatal(err)
	}
	...
	err = verifyKeysSiagOnePointZero(kp.UnlockConditions, "", "siag_1.0_2of3")
	if err != nil {
		t.Fatal(err)
	}
	...
	err = verifyKeysSiagOnePointZero(kp.UnlockConditions, "", "siag_1.0_3of3")
	if err != nil {
		t.Fatal(err)
	}
	...
	err = verifyKeysSiagOnePointZero(kp.UnlockConditions, "", "siag_1.0_4of9")
	if err != nil {
		t.Fatal(err)
	}
}
